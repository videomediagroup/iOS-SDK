...
SWIFT_MODULE_NAMESPACE_PUSH("VMGSDK")
...
SWIFT_CLASS("_TtC6VMGSDK9VMGAdView")
@interface VMGAdView : UIView <SFSafariViewControllerDelegate, UINavigationControllerDelegate, UIWebViewDelegate>
